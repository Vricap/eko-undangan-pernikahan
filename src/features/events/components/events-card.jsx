 ...
 * @param {string} props.eventData.maps_embed - The time zone of the event.
 *
 * @example
 * const eventData = {
 *   date: '2023-10-15',
        ...
        <div className={cn("space-y-3 text-gray-600")}>
          ...
          <div className={cn("flex items-center space-x-3")}>
            ...
            <span>
              ...
              {/* {eventData.endTime?.substring(0, 5) || eventData.endTime}*/} Selesai
            </span>
          </div>
          <div className={cn("flex items-center space-x-3")}>
          ...
          {/* GOOLE MAP SCAN from eventData.mapScan*/}
          {/* GOOGLE MAPS EMBED */}
          {eventData.maps_embed && (
            <motion.div
              variants={fadeUp}
              initial="hidden"
              animate="visible"
              className="mt-4 overflow-hidden rounded-2xl border border-rose-100 shadow-sm"
            >
              <iframe
                src={eventData.maps_embed}
                title="Lokasi Acara"
                width="100%"
                height="280"
                style={{ border: 0 }}
