        ...
        <div className={cn("container mx-auto px-4 py-20 relative z-10")}>
          ...
          >
            <button
              ...
              className="w-full rounded-2xl border border-rose-200 bg-white/80 px-6 py-4 shadow-lg backdrop-blur-sm transition-all hover:bg-rose-50"
            >
              <div className="flex items-center justify-center gap-3">
                <Wallet className="w-5 h-5 text-rose-500" />
                <span className="font-medium text-gray-800">
                  {showBanks ? "Sembunyikan Rekening" : "Tampilkan Rekening"}
                </span>
              </div>
            </button>
          </motion.div>
          ...
          <AnimatePresence>
            {showBanks && (
              <motion.div
                ...
                className="max-w-2xl mx-auto grid gap-6 overflow-hidden"
              >
